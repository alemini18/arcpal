// atom.cu — Atom-level propagation, block-per-rule deduction, host-loop iteration
//
// Uses reverse tables for incremental S_sat/S_undef updates.
// Block-level shared-memory reduction for init_sums.
